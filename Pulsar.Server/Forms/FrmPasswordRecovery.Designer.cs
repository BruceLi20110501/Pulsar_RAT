...
namespace Pulsar.Server.Forms
{
    partial class FrmPasswordRecovery
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.saveSelectedToolStripMenuItem.Text = "已选中";
            ...
            this.clearSelectedToolStripMenuItem.Text = "已选中";
            ...
            this.lblInfo.Text = "您可以通过调整上方文本框中的格式来更改账号的保存方式。\r\n可用变量：APP, URL, USER, PASS\r\n";
