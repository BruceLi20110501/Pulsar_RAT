...
namespace Pulsar.Client.Messages
{
    ...
    public class QuickCommandHandler : IMessageProcessor
    {
        ...
        {
            client.Send(new SetStatus { Message = "快捷命令执行成功" });
